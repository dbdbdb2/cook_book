...
class dbIsTyping extends StatefulWidget {
  const dbIsTyping({
    super.key,
  });

  @override
  State<dbIsTyping> createState() => _dbIsTypingState();
}

class _dbIsTypingState extends State<dbIsTyping> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Typing Indicator', style: TextStyle(fontSize: 40)),
      ),
      body: Column(
        children: [
          Expanded(
