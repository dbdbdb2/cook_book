...
class _ExampleCupertinoDownloadButtonState
  ...
  void initState() {
    super.initState();
    _downloadControllers = List<DownloadController>.generate(8,
  ...
  void _openDownload(int index) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Open App ${index + 1}', style: TextStyle(fontSize: 25)),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          centerTitle: true,
          title: const Text('Apps', style: TextStyle(fontSize: 35),)),
